// Small hand-authored line-icon set (Feather-style: 24x24 viewBox, stroke
// currentColor, no fill) so the app never depends on emoji glyphs, which
// render inconsistently across OS/browser and read as unprofessional in a
// business tool. Add new names here as needed instead of reaching for an
// emoji.
const PATHS = {
  ...
  kanban: <><rect x="3" y="3" width="18" height="18" rx="2" ry="2" /><rect x="7" y="7" width="3" height="9" /><rect x="14" y="7" width="3" height="5" /></>,
